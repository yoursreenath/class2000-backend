    ...
    CommandLineRunner seedData(
		...
		/*
            ...
            teacherRepo.save(Teacher.builder()
                    .firstName("Rajesh").lastName("Krishnamurthy")
                    .subject("Chemistry").designation("Head of Science Department")
                    .currentCity("Bangalore").currentStatus("Retired")
                    .yearsAtSchool("1985 - 2008")
                    ...
                    .email("rk@example.com").build());

            teacherRepo.save(Teacher.builder()
                    .firstName("Meena").lastName("Subramaniam")
                    .subject("Mathematics").designation("Class Teacher - 10th Grade")
                    .currentCity("Chennai").currentStatus("Still Teaching")
                    .yearsAtSchool("1990 - present")
                    ...
                    .email("meena@example.com").build());

            teacherRepo.save(Teacher.builder()
                    .firstName("Samuel").lastName("D'Souza")
                    .subject("English Literature").designation("Senior Teacher")
                    .currentCity("Mumbai").currentStatus("Retired")
                    .yearsAtSchool("1988 - 2005")
                    .bio("His Shakespeare readings gave us all goosebumps. A man of eloquence and warmth who always had a story within a story. We miss his voice in the classroom.")
                    .email("samuel@example.com").build());

            teacherRepo.save(Teacher.builder()
                    .firstName("Lakshmi").lastName("Venkatesh")
                    .subject("History & Civics").designation("Department Head")
                    .currentCity("Hyderabad").currentStatus("Retired")
                    .yearsAtSchool("1983 - 2002")
                    ...
                    .email("lakshmi@example.com").build());

            teacherRepo.save(Teacher.builder()
                    .firstName("Anand").lastName("Pillai")
                    .subject("Physical Education").designation("Sports Coach")
                    .currentCity("Kochi").currentStatus("Still Teaching")
                    .yearsAtSchool("1992 - present")
                    .bio("The man behind every medal and every sportsday champion. His morning drills were tough, but his belief in every student was tougher.")
                    .email("anand@example.com").build());
            ...
            if (initiativeRepo.count() == 0) {
                initiativeRepo.save(Initiative.builder()
                    ...
                    .description("Our class came together, pooled our resources, and built a dedicated vehicle stand for our beloved school. A small token of gratitude to the place that gave us everything — now standing as a permanent reminder of who we are and where we came from.")
                    .type("infrastructure")
                ...
                initiativeRepo.save(Initiative.builder()
                    ...
                    .description("We remember our classmates who are no longer with us. Their children deserve every opportunity to thrive. Our class collectively raised funds and extended a helping hand — because true friendship does not end, it passes on to the next generation.")
                    .type("support")
